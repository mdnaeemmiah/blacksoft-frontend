  ...
  const values: ValueItem[] = [
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className={styles.iconSvg}>
  ...
  return (
    <div 
      ...
      style={{
        ...
        transition: `opacity 0.7s ${index * 0.12}s var(--ease-out), transform 0.7s ${index * 0.12}s var(--ease-out)`,
      }}
    >
